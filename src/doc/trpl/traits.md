...
type `Rectangle` and its operation `is_square`:
...
Implementors of the `Foo` trait need to implement `valid()`, but they don’t
...
impl Foo for OverrideDefault {
    ...
    fn is_invalid(&self) -> bool {
        println!("Called OverridDefault.is_invalid!");
...
assert!(over.is_invalid()); // prints "Called overridden is_invalid!"
```
